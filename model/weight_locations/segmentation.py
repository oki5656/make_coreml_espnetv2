...
for scale in espnetv2_scales:
    model_weight_map['espnetv2_{}'.format(scale)] = {
        'mydataset_640x480':
        {
            #################################   weight folder location   ###################################
            'weights': 'results_segmentation/model_espnetv2_mydataset/s_2.0_sch_hybrid_loss_ce_res_640_sc_1.0_2.0/20201118-141206/espnetv2_{}_640_best.pth'.format(scale)
        },
        'pascal_256x256':
        {
